...
This is a problem, because many programming problems suitable for beginners are easily solved by genAI systems because they are well documented.
However, the reinforced habit of trusting the results without checking them can be dangerous once stepping up to more complex tasks.
...
In order to be able to review results generated by an AI, the user needs to understand the resulting programs.
...
This effectively means that junior people never have the opportunity to mature into senior roles, yet those senior roles are very much required to check the entire process.
In addition, programming as well as learning how to program is a social activity.
...
Programs needed to be typed, needed to be read, and needed to be unterstood in detail.
