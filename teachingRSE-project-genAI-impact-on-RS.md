...
As evidenced by this example, the notion of teaching people "algorithmic thinking", the ability to analyze a problem
...
We also think that knowing an actual programming language will become a qualification of only a small and specialised group.
